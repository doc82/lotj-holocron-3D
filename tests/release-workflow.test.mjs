...
test("pull requests run every supported test layer with an explicit pnpm setup", async () => {
  ...
  assert.match(workflow, /lua5\.1 tests\/parsers\.test\.lua/);
  assert.match(workflow, /lua5\.1 tests\/scraper\.test\.lua/);
