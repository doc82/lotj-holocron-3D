  ...
  return (
    <section className={styles.uplink} role="status" aria-live="polite">
      ...
      <p className={styles.eyebrow}>
        TACTICAL LINK // {paused ? "SPACE TELEMETRY PAUSED" : "STANDBY"}
      </p>
      <h2>
        {paused
          ? "Waiting for space telemetry, Captain"
          : "Waiting for uplink to your Ship, Captain"}
      </h2>
      <p className={styles.detail}>
        {paused ? (
          ...
          <>
            Launch the Holocron3D Mudlet package or enter <code>h3d start</code>
          </>
        )}
      </p>
